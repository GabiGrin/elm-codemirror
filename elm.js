...
Elm.Native.CodeMirror.make = function(elm) {
  ...
  Hook.prototype.initialize = function(node, propertyName, previousValue) {
    ...
    this.codeMirror = CodeMirror(node, {
      value: "",
      mode: "elm",
      theme: "monokai"
    });
  ...
  Hook.prototype.setNewValue = function(previousValue) {
  ...
  Hook.prototype.update = function(node, propertyName, previousValue) {
    ...
    this.setNewValue(previousValue);
  };
...
Elm.CodeMirror.make = function (_elm) {
   ...
   var Config = F3(function (a,b,c) {    return {theme: a,mode: b,value: c};});
   return _elm.CodeMirror.values = {_op: _op,codeMirror: codeMirror,Config: Config};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var config = {mode: "elm",theme: "monokai",value: "hello world"};
   var view = A2($Html.div,_U.list([]),_U.list([$CodeMirror.codeMirror(config)]));
   var main = $Signal.constant(view);
   return _elm.Main.values = {_op: _op,main: main,config: config,view: view};
};
