...
Elm.Main.make = function (_elm) {
   ...
   _U.list([]),
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("elm-codemirror example")]))
           ,A2($Html.p,
           _U.list([]),
   ...
   var view = F2(function (add,model) {
      ...
      _U.list([header
              ...
              _U.list([container(_U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Instance 1")])),A2(codeMirrorView,add,model)]))
